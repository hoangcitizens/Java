...
public class Test {
    // todo 5: sử dụng enum sao cho hợp lý
    ...
    private static int createFakeStudents(Student[] students) {
        var counter = 0;
        students[counter++] = new Student("ST1001", "Nguyễn Ngọc Mai", Major.CNTT, "ngocmai@xmail.com", 3.77f);
        students[counter++] = new Student("ST1007", "Lý Thảo Mai", Major.QTKD, "thaomai@xmail.com", 3.77f);
        students[counter++] = new Student("ST1002", "Lê Thanh Mai", Major.DT, "thanhmai@xmail.com", 3.77f);
        students[counter++] = new Student("ST1003", "Trần Bích Mai", Major.CNTT, "bichmai@xmail.com", 3.05f);
        students[counter++] = new Student("ST1004", "Nguyễn Ngọc Ánh", Major.CNTT, "ngocanh@xmail.com", 3.59f);
        students[counter++] = new Student("ST1005", "Hoàng Thanh Tùng", Major.CNTT, "thanhtung@xmail.com", 3.74f);
        students[counter++] = new Student("ST1006", "Lưu Bá Nam", Major.ATTT, "banam@xmail.com", 3.15f);
        students[counter++] = new Student("ST1008", "Dương Trung Quốc", Major.ATTT, "trungquoc@xmail.com", 3.45f);
        return counter;
    }
