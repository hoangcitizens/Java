...
/*
    ...
    nội dung, tác giả, ngày đăng, thể loại. Bổ sung các constructor và tái sử dụng chúng sao cho hợp lệ, sử dụng tính
    đóng gói dữ liệu và tự bổ sung các phương thức phụ trợ cần thiết. Viết chương trình có menu chọn cho phép thực hiện
    các chức năng sau:
        1. Thêm bài viết mới vào danh sách các bài viết. Mỗi bài viết có một mã bài viết duy nhất và chỉ xuất hiện 1 lần
           trong danh sách các bài viết.
...
// todo 4: sử dụng các getter/setter sao cho hợp lý
public class Test {
