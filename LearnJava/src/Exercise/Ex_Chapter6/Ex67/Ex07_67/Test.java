...
/*
    ...
    các chức năng sau:
        1. Thêm mới sinh viên vào danh sách các sinh viên. Mỗi sinh viên xuất hiện không quá 1 lần trong danh sách này.
...
public class Test {
    // todo 1: sử dụng ArrayList thay cho mảng
    ...
    private static void createFakeStudents(ArrayList<Student> students) {
        students.add(new Student(null, "Nguyễn Ngọc Mai", Major.CNTT, "ngocmai@xmail.com", 3.77f));
        students.add(new Student(null, "Lý Thảo Mai", Major.QTKD, "thaomai@xmail.com", 3.77f));
        students.add(new Student(null, "Lê Thanh Mai", Major.DT, "thanhmai@xmail.com", 3.77f));
        students.add(new Student(null, "Trần Bích Mai", Major.CNTT, "bichmai@xmail.com", 3.05f));
        students.add(new Student(null, "Nguyễn Ngọc Ánh", Major.CNTT, "ngocanh@xmail.com", 3.59f));
        students.add(new Student(null, "Hoàng Thanh Tùng", Major.CNTT, "thanhtung@xmail.com", 3.74f));
        students.add(new Student(null, "Lưu Bá Nam", Major.ATTT, "banam@xmail.com", 3.15f));
        students.add(new Student(null, "Dương Trung Quốc", Major.ATTT, "trungquoc@xmail.com", 3.45f));
    }

    private static boolean isStudentExisted(ArrayList<Student> students, String studentId) {
    ...
    public static void listFailedStudent(ArrayList<Student> students) {
        var counter = 0;
        for (var student : students) {
    ...
    public static boolean removeStudent(ArrayList<Student> students, String id) {
        boolean isExisted = isStudentExisted(students, id); // kiểm tra xem sv có tồn tại không đã
        if (isExisted) {
            for (int i = 0; i < students.size(); i++) {
                if (students.get(i).getId().compareToIgnoreCase(id) == 0) {
                    students.remove(i); // xóa khỏi array list
                    break;
                }
            }
        }
    ...
    public static boolean updateGpa(ArrayList<Student> students, String studentId, float gpa) {
    ...
    public static void statisticByMajor(ArrayList<Student> students) {
        for (var index = 0; index < students.size(); index++) {
    ...
    private static int countStudent(ArrayList<Student> students, String major, String level) {
        var counter = 0;
        for (var student : students) {
    ...
    private static boolean isMajorExisted(ArrayList<Student> students, String major, int pos) {
        for (int i = 0; i < pos; i++) {
            if (major.compareTo(students.get(i).getMajor()) == 0) {
                return true;
            }
        }
        return false;
    ...
    public static void topGpa(ArrayList<Student> students) {
        sortByGpaASC(students);
        var maxGpa = students.getLast().getGpa(); // lấy phần tử cuối
    ...
    public static void findByGpa(ArrayList<Student> students, float gpa) {
    ...
    public static void findByName(ArrayList<Student> students, String name) {
        System.out.println("==> Kết quả tìm kiếm: ");
        System.out.printf("%-15s%-25s%-20s%-25s%-15s\n", "Mã SV",
                "Họ và tên", "Chuyên ngành", "Email", "Điểm GPA");
        var counter = 0;
    ...
    public static void rankedAcademic(ArrayList<Student> students) {
    ...
    public static void scholarshipConsideration(ArrayList<Student> students) {
    ...
    private static void sortByGpaASC(ArrayList<Student> students) {
    ...
    private static void sortByGpaDESC(ArrayList<Student> students) {
        for (var i = 0; i < students.size(); i++) {
            for (var j = students.size() - 1; j > i; j--) {
                if (shouldSwapStudent(students.get(j), students.get(j - 1))) {
                    var student = students.get(j - 1);
    ...
    public static void showStudentInTable(ArrayList<Student> students) {
        var line = "======================================";
