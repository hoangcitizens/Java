...
/*
    ...
    menu chọn cho phép thực hiện các chức năng sau:
        ...
        6. Tính tổng tiền hàng tồn kho hiện có trong danh sách.
...
public class Test {
    ...
    private static int createFakeItems(Item[] items) {
        int itemCount = 0;
        items[itemCount++] = new Item(null, "Mì hảo hảo", "AceCook", 4500, "01/01/2024", "12/06/2024", 10000, 1325, ItemType.LUONG_THUC);
        items[itemCount++] = new Item(null, "Mì siêu cay", "AceCook", 15500, "01/01/2024", "15/09/2024", 1000, 425, ItemType.LUONG_THUC);
        items[itemCount++] = new Item(null, "Mì trộn", "AceCook", 12600, "01/01/2024", "15/08/2024", 2000, 376, ItemType.LUONG_THUC);
        items[itemCount++] = new Item(null, "Mì tào phớ", "Massan", 5700, "01/01/2024", "01/06/2024", 3000, 185, ItemType.LUONG_THUC);
        items[itemCount++] = new Item(null, "Mì khoai môn", "AceCook", 4900, "01/01/2024", "02/08/2024", 5000, 854, ItemType.LUONG_THUC);
        items[itemCount++] = new Item(null, "Mì sắn dây", "Massan", 6300, "01/01/2024", "15/09/2024", 1000, 267, ItemType.LUONG_THUC);
        items[itemCount++] = new Item(null, "Mì cung đình", "Micoem", 6500, "01/01/2024", "12/07/2024", 3000, 0, ItemType.LUONG_THUC);
        items[itemCount++] = new Item(null, "Cẩu lương", "Couple", 1000, "01/01/2024", "31/12/2024", 1000, 0, ItemType.LUONG_THUC);
        return itemCount;
    }
