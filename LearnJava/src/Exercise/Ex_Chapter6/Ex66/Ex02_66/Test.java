package Exercise.Ex_Chapter6.Ex66.Ex02_66;

/*
    Bài 2. Thông tin về địa chỉ bao gồm: mã địa chỉ có dạng ADDxxxx(ví dụ ADD0001), phần số tự động tăng từ 1000,
    số nhà, ngõ, tên đường, tên xóm, tên xã/phường, quận(huyện)/thị trấn, tỉnh/thành phố. Trong đó tỉnh/thành phố là
    một enum bao gồm 63 tỉnh thành của Việt Nam. Thiết kế lớp mô tả đối tượng địa chỉ như trên. Bổ sung các constructor
    phù hợp có thể tái sử dụng một cách hợp lý, sử dụng tính đóng gói dữ liệu và tự bổ sung các phương thức phụ trợ
    cần thiết. Yêu cầu constructor ít tham số gọi tới constructor nhiều tham số khi tái sử dụng. Tạo chương trình có
